    ...
    public class ForLoopParserTests(ITestOutputHelper output) : ParserTestBase(output)
    {
        ...
        public void ParsesSimpleSingleLineForLoopCorrectly()
        {
            ...
            var expectedCode = new List<InstructionLine>
            {
                ...
                new(InstructionCode.GotoIfFalse, new NumberValue(10), new TempValue(0)),
                ...
                new(InstructionCode.Add, new TempValue(1), new VariableValue("a"), new NumberValue(1)),
        ...
        public void ParsesComplexNestedForLoopWithBreaksAndContinuesCorrectly()
        {
            ...
            var expectedCode = new List<InstructionLine>
            {
                ...
                new(InstructionCode.Assign, new VariableValue("i"), new NumberValue(0)),
                new(InstructionCode.LessThan, new TempValue(0), new VariableValue("i"), new NumberValue(10)),
                new(InstructionCode.GotoIfFalse, new NumberValue(33), new TempValue(0)),
                ...
                new(InstructionCode.GotoIfFalse, new NumberValue(13), new TempValue(2)),
                new(InstructionCode.Goto, new NumberValue(33)),
                new(InstructionCode.Equal, new TempValue(3), new VariableValue("a"), new NumberValue(6)),
                new(InstructionCode.GotoIfFalse, new NumberValue(16), new TempValue(3)),
                ...
                new(InstructionCode.GotoIfFalse, new NumberValue(32), new TempValue(4)),
                new(InstructionCode.Goto, new NumberValue(23)),
                ...
                new(InstructionCode.Add, new TempValue(6), new VariableValue("z"), new NumberValue(1)),
                ...
                new(InstructionCode.GotoIfFalse, new NumberValue(28), new TempValue(7)),
                new(InstructionCode.Goto, new NumberValue(32)),
                new(InstructionCode.Equal, new TempValue(8), new VariableValue("z"), new NumberValue(6)),
                new(InstructionCode.GotoIfFalse, new NumberValue(31), new TempValue(8)),
