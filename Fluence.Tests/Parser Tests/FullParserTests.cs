    ...
    public class FullParserSuite : ParserTestBase
    {
        ...
        public void ParsesFullCalculatorProgramCorrectly()
        {
            ...
            var expectedCode = new List<InstructionLine>
            {
                ...
                new(InstructionCode.Assign, new VariableValue("Main"), new FunctionValue("Main", 0, 8, "0008")),
                new(InstructionCode.Goto, new NumberValue(62)),
                ...
                new(InstructionCode.GotoIfFalse, new NumberValue(50), new TempValue(10)),
                new(InstructionCode.Equal, new TempValue(12), new VariableValue("op"), new StringValue("+")),
                new(InstructionCode.GotoIfFalse, new NumberValue(26), new TempValue(12)),
                ...
                new(InstructionCode.GotoIfFalse, new NumberValue(31), new TempValue(14)),
                ...
                new(InstructionCode.GotoIfFalse, new NumberValue(36), new TempValue(16)),
                ...
                new(InstructionCode.GotoIfFalse, new NumberValue(46), new TempValue(18)),
                new(InstructionCode.Equal, new TempValue(19), new VariableValue("num2"), new NumberValue(0)),
                new(InstructionCode.GotoIfFalse, new NumberValue(42), new TempValue(19)),
                ...
                new(InstructionCode.GotoIfFalse, new NumberValue(56), new TempValue(23)),
                new(InstructionCode.Assign, new TempValue(24), new StringValue("Error: Invalid operation or division by zero.")),
                new(InstructionCode.Goto, new NumberValue(59)),
        ...
        public void ParsesMatchExpressionAsFunctionReturnValue()
        {
            ...
            var expectedCode = new List<InstructionLine>
            {
                ...
                new(InstructionCode.GotoIfFalse, new NumberValue(10), new TempValue(2)),
